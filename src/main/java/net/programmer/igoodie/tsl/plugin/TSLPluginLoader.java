...
public class TSLPluginLoader {
    ...
    public TSLPluginLoader(TheSpawnLanguage tsl, File file) {
        this(tsl, file.toURI());
    }

    public TSLPluginLoader(TheSpawnLanguage tsl, URI uri) {
        this.tsl = tsl;
        this.uri = uri;
    }
    ...
    private void loadPlugin() throws TSLPluginLoadingException {
