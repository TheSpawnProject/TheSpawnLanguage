...
@Deprecated
public class TSLRulesetOld implements ConstantAttributeGenerator {
    ...
    protected List<TSLRuleOld> rules;
    ...
    protected List<TSLRulesetOld> importedRulesets;

    protected HookList hookList;

    public TSLRulesetOld(TheSpawnLanguage tsl) {
        this(tsl, null, null);
    }

    public TSLRulesetOld(TheSpawnLanguage tsl, @Nullable String name, @Nullable File file) {
        this.name = name;
        this.file = file;
    ...
    public List<TSLRuleOld> getRules() {
    ...
    public List<TSLRulesetOld> getImportedRulesets() {
...
//        tagDefinition.onLoaded(this, tagSnippet);
    ...
    public void addRule(TSLRuleOld rule) {
        addRule(rule, false);
    }

    public void addRule(TSLRuleOld rule, boolean outsource) {
    ...
    public void importRuleset(TSLRulesetOld otherRuleset) {
        ...
        for (TSLRuleOld rule : otherRuleset.rules) {
            addRule(rule, true);
        }
